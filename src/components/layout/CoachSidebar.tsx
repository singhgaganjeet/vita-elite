...
import { LayoutDashboard, Calendar, Users, TrendingUp, User, LogOut, ChevronLeft } from 'lucide-react';
...
export default function CoachSidebar({ open, onToggle }: CoachSidebarProps) {
